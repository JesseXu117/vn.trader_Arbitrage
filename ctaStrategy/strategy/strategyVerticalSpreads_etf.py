...
########################################################################
class ETFVerticalSpreadStrategy(CtaArbitrageTemplate):
    """垂直无风险套利策略"""
    strategyName = u'垂直无风险套利策略'  # 策略实例名称
    className = u'ETFVerticalSpreadStrategy'
    author = u'Jesse'
    ...
    def __init__(self, ctaEngine, setting):
        """Constructor"""
        super(ETFVerticalSpreadStrategy, self).__init__(ctaEngine, setting)
...
if __name__ == '__main__':
    ...
    # 在引擎中创建策略对象
    engine.initStrategy(ETFVerticalSpreadStrategy, {})
