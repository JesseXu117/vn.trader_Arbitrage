...
from ctaStrategy.uiCtaWidget_Arbitrage import CtaEngineManager
from dataRecorder.uiDrWidget import DrEngineManager
from riskManager.uiRmWidget import RmEngineManager


########################################################################
class MainWindow_Arbitrage(QtGui.QMainWindow):
    """主窗口"""
    ...
    def __init__(self, mainEngine, eventEngine):
        """Constructor"""
        super(MainWindow_Arbitrage, self).__init__()
    ...
    def openCta(self):
        ...
        except KeyError:                    # by Jesse
            self.widgetDict['ctaM'] = CtaEngineManager(self.mainEngine.ctaEngine_Arbitrage, self.eventEngine)
            self.widgetDict['ctaM'].showMaximized()
